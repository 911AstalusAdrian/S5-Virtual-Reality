...
namespace ray_tracer
{
    ...
    {
        private string assetFileName = "D:\\Uni\\VR - Virtual Reality\\volume-renderer-911AstalusAdrian\\VolumeRenderer\\assets\\head-181x217x181.dat";
        public static double fromOriginPositionX = -200;
        public static double fromOriginPositionY = -80;
        public static double fromOriginPositionZ = -130;
